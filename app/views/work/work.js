    ...
    onShow: modal => {
        modalMain.innerHTML = `
          ...
          <main class="modal__content">
            <p class="description">${htmlParser.parseFromString(modalContent.description, 'text/html').body.innerHTML}</p>
          ...
          <footer class="modal__footer">
              <a class="button" href="${modalContent.link}" target="_blank">demo</a>
          </footer>
        `;
